export default function Chocolate() {
    return (
      <div className="cake-parent">
          <h1 className="h1-text">BlackForest Cake Recipe</h1>
        <div className="cake-child">
          ...
          <ol>
              ...
              <li>Combine the Butter and Sugar</li>
              ...
              <li>Cool the Cake Layers</li>
              <li>Assemble the Cake</li>
              <li>Add a Crumb Coat</li>
          </ol>
        </div>
      </div>
    );
